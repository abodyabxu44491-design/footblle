...
(function () {
  ...
  function render() {
    ...
    list.forEach(function (m) {
      var k, sk;
      /* 🔴 كان التوجيه لمجموعة «الملحق/الإقصاء» يعتمد على التبويب النشط
         (active === 'po'/'ko') فقط — فمباراة إقصاء ضمن تبويب «الكل» ما
         كانت تدخل هذا الشرط أبداً، وتسقط بدلاً منه في تجميع الجَولة
         العادية على أساس m.round، وهو رقم دور الشجرة (١ لأول دور إقصاء)
         فتندمج بصريّاً مع «الجولة ١» لمباريات المجموعات. الصحيح: أي
         مباراة ملحق/إقصاء تُجمَّع في مجموعتها الخاصة دائماً، في أي تبويب،
         بصرف النظر عن كونه «الكل» أو «منتهية» أو غيره. */
      if (isPO(m)) {
